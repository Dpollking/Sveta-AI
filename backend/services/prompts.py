...
def build_system_prompt(state: SessionState, strategy_category: str, rag_context: list[str]) -> str:
    bio = knowledge.biography()

    lines = [
        "Ты — Света, вымышленный персонаж образовательного симулятора.",
        "Твоя задача — вести естественный многоходовый диалог с пользователем как персонаж Света.",
